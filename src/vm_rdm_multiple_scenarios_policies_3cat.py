...
# outdir = "C:\\Users\\wb558960\\OneDrive - WBG\\CCDRs LAC\\Argentina\\DeepDives\\Vaca Muerta\\Python\\outputs_rdm\\outputs_v6\\8pol_1000\\"
...
outdir = f"outputs_rdm\\outputs_v7\\8pol_{num_experiments}/"
...
#22 uncertainties
    ...
    policies = [Policy('1',public_ds_capex_share=0.67,share_covered=0.17,prod_subsidy_p_ratio=1.3,gas_ex_cap_end=110000,gas_ex_cap_increase=30,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.12,duty_rate_gas=0.08,royalty_rate_oil=0.12,duty_rate_oil=0.08,profit_tax_rate=0.3),
                Policy('2',public_ds_capex_share=0.67,share_covered=0.17,prod_subsidy_p_ratio=1.3,gas_ex_cap_end=110000,gas_ex_cap_increase=30,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.05,duty_rate_gas=0,royalty_rate_oil=0.05,duty_rate_oil=0,profit_tax_rate=0.15),
                Policy('3',public_ds_capex_share=0,share_covered=0,prod_subsidy_p_ratio=1,gas_ex_cap_end=110000,gas_ex_cap_increase=30,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.12,duty_rate_gas=0.08,royalty_rate_oil=0.12,duty_rate_oil=0.08,profit_tax_rate=0.3),
                Policy('4',public_ds_capex_share=0,share_covered=0,prod_subsidy_p_ratio=1,gas_ex_cap_end=110000,gas_ex_cap_increase=30,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.05,duty_rate_gas=0,royalty_rate_oil=0.05,duty_rate_oil=0,profit_tax_rate=0.15),
                Policy('17',public_ds_capex_share=0.67,share_covered=0.17,prod_subsidy_p_ratio=1.3,gas_ex_cap_end=4631,gas_ex_cap_increase=3,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.12,duty_rate_gas=0.08,royalty_rate_oil=0.12,duty_rate_oil=0.08,profit_tax_rate=0.3),
                Policy('18',public_ds_capex_share=0.67,share_covered=0.17,prod_subsidy_p_ratio=1.3,gas_ex_cap_end=4631,gas_ex_cap_increase=3,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.05,duty_rate_gas=0,royalty_rate_oil=0.05,duty_rate_oil=0,profit_tax_rate=0.15),
                Policy('19',public_ds_capex_share=0,share_covered=0,prod_subsidy_p_ratio=1,gas_ex_cap_end=4631,gas_ex_cap_increase=3,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.12,duty_rate_gas=0.08,royalty_rate_oil=0.12,duty_rate_oil=0.08,profit_tax_rate=0.3),
                Policy('20',public_ds_capex_share=0,share_covered=0,prod_subsidy_p_ratio=1,gas_ex_cap_end=4631,gas_ex_cap_increase=3,oil_ex_cap_end=76650,oil_ex_cap_increase=30,royalty_rate_gas=0.05,duty_rate_gas=0,royalty_rate_oil=0.05,duty_rate_oil=0,profit_tax_rate=0.15)]
